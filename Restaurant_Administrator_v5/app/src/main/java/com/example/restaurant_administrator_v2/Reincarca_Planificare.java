...
public class Reincarca_Planificare extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.adauga_comanda:
                Toast.makeText(Reincarca_Planificare.this, "Comanda adaugata.", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.anuleaza_comanda:
                Toast.makeText(Reincarca_Planificare.this, "Comanda anulata.", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.schimba_masa:
                Toast.makeText(Reincarca_Planificare.this, "Comanda mutata.", Toast.LENGTH_SHORT).show();
                return true;
            default:
                return false;
        }
        ...
        reincarca_planificarea.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        vc = new VerificaConexiune(Reincarca_Planificare.this);
                        ...
                        if (!vc.isConnected()) {
                                    ...
                                    if (nume_imagine != null) {
                                        ...
                                        switch (nume_imagine) {
                                            ...
                                            case "adaugare_perete_5":
                                                imageView.setBackgroundResource(R.mipmap.ic_launcher_foreground_perete_5);
                                                break;
                                            ...
                                            case "adaugare_perete_4":
                                                imageView.setBackgroundResource(R.mipmap.ic_launcher_foreground_perete_4);
                                                break;
                                        }
                            ...
                            for (i = 0; i < numar_linii + 1; i++) {
                                for (j = 0; j < numar_coloane + 1; j++) {
                                    ...
                                    final LinearLayout celula = new LinearLayout(Reincarca_Planificare.this);
                                    celula.setOrientation(LinearLayout.VERTICAL);
                                    RelativeLayout.LayoutParams lp1 = new RelativeLayout.LayoutParams(latime_celula, latime_celula);
                                    lp1.setMargins(j * latime_celula, i * latime_celula, 0, 0);
                                    celula.setLayoutParams(lp1);
                                                                ...
                                                                case "adaugare_masa":
                                                                    ...
                                                                    imageView.setOnClickListener(
                                                                            new View.OnClickListener() {
                                                                                @Override
                                                                                public void onClick(View v) {
                                                                                    Context wrapper = new ContextThemeWrapper(Reincarca_Planificare.this, R.style.popupMenuStyle);
                                                                                    PopupMenu popupMenu = new PopupMenu(wrapper, v);
                                                                                    popupMenu.setOnMenuItemClickListener(Reincarca_Planificare.this);
                                                                                    popupMenu.inflate(R.menu.popup_table);
                                                                                    popupMenu.getMenu().getItem(0).setTitle("  Masa " + numar_masa);
                                                                                    popupMenu.show();
                                                                                    Toast.makeText(Reincarca_Planificare.this, String.valueOf(v.getId()), Toast.LENGTH_SHORT).show();
