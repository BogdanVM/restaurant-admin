                ...
                for (int j = 0; j < get_numar_celula_latime(); j++) {
                    ...
                    if (i == 0 && j == 0) {
                        ...
                        dbRef.collection("celule").document("celula_" + String.valueOf(i) + "_" + String.valueOf(j)).set(celula).addOnSuccessListener(
                                new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        //Toast.makeText(MainActivity.this, "O mers", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(
                                        new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                //Toast.makeText(MainActivity.this, "Nu o mers", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                );
                        ...
                        dbRef.collection("celule").document("celula_" + String.valueOf(i) + "_" +
                                String.valueOf(j)).set(celula).addOnSuccessListener(
                                new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        //Toast.makeText(MainActivity.this, "O mers", Toast.LENGTH_SHORT).show();
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ref.whereEqualTo("IdCelula", celula.getTag()).get().addOnCompleteListener(
                                        ...
                                        new OnFailureListener() {
                                            @Override
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(MainActivity.this, "Nu o mers", Toast.LENGTH_LONG).show();
                                            }
                                        }
                                );
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (numarMasaDisponibil.size() > 0)
                        Toast.makeText(MainActivity.this, String.valueOf(numarMasaDisponibil.getLast()), Toast.LENGTH_LONG).show();
